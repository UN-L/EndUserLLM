...
\reflect[split=Brown400 and Brown500]{
  ...
  \fill [fill color] (0, 32) ellipse [x radius=128, y radius=112]; %These parts refer to the shape of a heart placed over the dog's face, covering the forehead and eye area.
  \fill [fill color] (32,96) %These parts refer to the dog's ears.
...
\reflect[split={BlueGrey800 and BlueGrey900}]{
  ...
  \fill [BlueGrey900] (56, 0) circle [radius=20]; %Change the color of the eyes to red
