...
\reflect[split=Brown400 and Brown500]{
  ...
  \fill [fill color] (0, 32) ellipse [x radius=128, y radius=112];  % Represents the white fur of the dog's face
  \fill [fill color] (32,96)
  .. controls ++( 75:128) and ++(105:128) .. ++(192,  0)
  .. controls ++(285: 96) and ++(285: 96) .. ++(-80,-32)
  .. controls ++(105: 64) and ++( 75: 32) .. cycle;  % Represents the patches around the eyes and the white stripe on the face
}
\reflect[split={Grey100 and Grey200}]{
  ...
  \fill [fill color](0,-224) 
    ...
    .. controls ++(270:64) and ++(180:64) .. cycle;  % Represents the floppy ears of the dog
}
\reflect[split={Pink100 and Pink200}]{
  \fill [fill color](0,-192) ellipse [x radius=28, y radius=32];  % Represents the tongue sticking out
}
\reflect[split={BlueGrey800 and BlueGrey900}]{
  \fill [fill color](0,-144) 
    ...
    .. controls ++(225:20) and ++(180:20) .. cycle;  % Represents the nose
  \fill [BlueGrey900] (56, 0) circle [radius=20];  % Represents the eyes
  \fill [fill color] (-8,-112)
  -- ++(16,0) -- ++(0,-32) arc (180:360:24)
  arc (180:0:8) arc (360:180:40);  % Represents the mouth
}
\end{scope}}
}
\begin{document}
...
\scoped[shift={(\x,\y)}]{
\fill [fill=\materialColor50] circle [radius=2];  % Represents the circular border around the illustration
\pic {\animal};  % Represents the dog illustration
