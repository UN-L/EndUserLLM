...
% Define TikZ styles and commands for creating the illustration
\tikzset{%
  ...
  % Define a style for splitting styles between left and right
...
% Define a command for creating symmetrical reflections
\newcommand\reflect[2][]{%
...
% Create the white patch on the face
...
\scoped[shift={(\x,\y)}]{
% Create the background circle with a pale, muted color
